...
from {package_name}.shared.protocol.messages import StatusMessage
...
for i in ['', '1', '2', '3']:
    pkg = f'DroneOS{i}'
    path = os.path.join(pkg, 'shared', 'utils', 'remote_log_handler.py')
    content = template.replace('{package_name}', pkg)
